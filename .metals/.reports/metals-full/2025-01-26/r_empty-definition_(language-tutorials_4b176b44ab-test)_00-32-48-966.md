error id: `<none>`.
file://<WORKSPACE>/learn-scala/Coursera%20-%20Functional%20Programming%20in%20Scala/1.%20Getting%20Started/assignments/1-getting-started/example/src/test/scala/example/ListsSuite.scala
...
class ListsSuite extends munit.FunSuite:
  ...
  test("test new max val") {
    assertEquals(max(List(1,2,3)), 3)
  }
