    ...
    def recur(occ: Occurrences, iter: Int): List[Sentence] = {
      ...
      if occ.isEmpty then {
        ...
        for 
          ...
          tailAnagrams <- recur(subtract2(occ, subset), iter+1)
        yield
          // println(s"""${"  "*iter}subset: $subset""")
          // println(s"""${"  "*iter}word: $word""")
          // println(s"""${"  "*iter}occ: $occ""")
          // println(s"""${"  "*iter}subset: $subset""")
          // println(s"""${"  "*iter}subtract(occ, subset): ${subtract(occ, subset)}""")
          // println(s"""${"  "*iter}subtract2(occ, subset): ${subtract2(occ, subset)}""")
...
@main def main() = {
  ...
  // println(Anagrams.sentenceAnagrams(List("i", "a", "b", "c", "am", "g")))
  println(Anagrams.sentenceAnagrams(List("Linux", "rulez")))
}